...
ALTER TABLE "profiles" ADD COLUMN "pin_intentos" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "profiles" ADD COLUMN "pin_bloqueado_hasta" timestamp with time zone;--> statement-breakpoint
