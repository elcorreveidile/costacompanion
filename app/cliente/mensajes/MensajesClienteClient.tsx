                ...
                {conversaciones.map((conv) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      {conv.acompanante?.foto_url ? (
                        // eslint-disable-next-line @next/next/no-img-element
                        <img
                          src={conv.acompanante.foto_url}
                          alt={conv.acompanante.nombre_publico}
              ...
              <div className="md:col-span-2">
                ...
                >
                  ...
                  <div className="p-4 border-b flex items-center gap-3" style={{ borderColor: 'var(--line)' }}>
                    {conversacionActiva.acompanante?.foto_url ? (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img
                        src={conversacionActiva.acompanante.foto_url}
                        alt={conversacionActiva.acompanante.nombre_publico}
