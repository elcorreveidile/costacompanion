      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-(--ink)/70">
            Tu área de anunciante (Local Partner) está en construcción
          </p>
        </div>
        ...
        <div className="bg-(--bone-2) rounded-lg p-8 shadow-sm border border-(--line) mb-6">
          ...
          <p className="text-(--ink) mb-6">
            Próximamente podrás gestionar tu ficha de Local Partner, ver tus estadísticas y actualizar tu plan desde aquí.
          </p>
        ...
        <div className="bg-(--bone-2) rounded-lg p-6 shadow-sm border border-(--line)">
          ...
          <div className="text-sm text-(--ink)/70 space-y-1">
            ...
            <p>Rol: Anunciante (Local Partner)</p>
