...
export default function ResenaPage() {
  ...
  // These are passed via searchParams in the URL: /[slug]/resena?id=...&nombre=...
  ...
  // Read acompanante_id from URL search params (set by the link in the microsite)
  const acompananteId = typeof window !== 'undefined'
    ? new URLSearchParams(window.location.search).get('id') ?? ''
    : '';
  const acompananteNombre = typeof window !== 'undefined'
    ? decodeURIComponent(new URLSearchParams(window.location.search).get('nombre') ?? '')
    : '';
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    fd.set('acompanante_id', acompananteId);
    fd.set('slug', slug);
